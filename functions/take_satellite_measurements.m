function take_satellite_measurements(Settings, sys_params, space_loc, k_loc, ...
        ...
        for idx_t=1:num_tsample 
           ...
           %load(fullfile(Settings.DataFolder,'primary_cell_group.mat'), 'primary_cell_group'); 
            ...
            %for ps=1:num_pserving               
               ...
               [primary_inr, secondary_inr, secondary_snr, sats_to_consider] = est_primary_system_rx_power(sys_params, unique_psat,unique_ksat, ...
